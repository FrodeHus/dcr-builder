...
export const dcrTooltips = {
  ...
  dataType_long: 'Large integer values in the range of -9223372036854775808 to 9223372036854775807.',
  dataType_real: 'Floating-point numbers (decimal values).',
  dataType_boolean: 'True or false values.',
  dataType_dynamic: 'Complex objects or arrays. Stored as JSON for flexible querying.',
  dataType_datetime:
