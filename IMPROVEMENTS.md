...
**File:** [src/routes/\_\_root.tsx](src/routes/__root.tsx)
...
**File:** [src/**tests**/dcr-e2e.test.ts](src/__tests__/dcr-e2e.test.ts)
...
| ------------------------ | ------ | ------------------------------------------------- |
| Error Boundary           | ✅     | ErrorBoundary.tsx, \_\_root.tsx                   |
...
| E2E Tests                | ✅     | **tests**/dcr-e2e.test.ts                         |
